...
public class MainActivity extends Activity {
    ...
    public void addTaskNow(View view) {
        if (myTask.getText().toString().isEmpty()) {
            ...
            ToDo_Item task = new ToDo_Item(myTask.getText().toString(), 0);
            new PerformAsyncTasks().execute();
    ...
    private class PerformAsyncTasks extends AsyncTask<Void, Integer, Void>{
        ToDo_Item task = new ToDo_Item(myTask.getText().toString(), 0);
