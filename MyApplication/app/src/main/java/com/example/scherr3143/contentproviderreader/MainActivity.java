package com.example.scherr3143.contentproviderreader;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickAddTitle(View view) {
        ...
        Uri uri = getContentResolver().insert(Uri.parse("content://com.example.scherr3143.contentproviderpart2.Books/books"), values);
    ...
    public void onClickRetrieveTitles(View view) {
        ...
        Uri allTitles = Uri.parse(
                "content://com.example.scherr3143.contentproviderpart2.Books/books");
        Cursor c;
